...
\paragraph{} Un \textit{objet} est composé d'une clé d'identification appelé \textit{token} et d'un ensemble de \textit{données}, codage (une représentation sous forme binaire), propre au système de base de données, d'une information quelconque.
