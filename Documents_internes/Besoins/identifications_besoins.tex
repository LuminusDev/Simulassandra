...
\begin{description}
\besoin{Synchroniser l'horloge interne des noeuds du réseau}{1}
\besoin{Définir un intervalle de temps périodique}{1}
\besoin{Modifier l'intervalle de temps périodique par une configuration}{3}{La configuration est accessible par l'utilisateur, et la valeur de l'intervalle de temps doit être la même pour tous les noeuds du réseau}
\besoin{Suspendre le traitement des requêtes de lecture}{1}
\besoin{Exécuter du code à temps périodique}{1}
\besoin{Reprendre le traitement des requêtes de lecture après une suspension}{1}
\end{description}
