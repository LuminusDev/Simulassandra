...
\paragraph{} Nous ne présentons pas les objets stockant les résultats des requêtes, comme \path{Row}, qui ne sont que des structures de données. 
...
\paragraph{} Lors de la création d'une session, nous devons créer un \path{KEYSPACE}.
...
\paragraph{} Pour visualiser les métriques, nous utilisons une application nommée \path{Graphite}.
