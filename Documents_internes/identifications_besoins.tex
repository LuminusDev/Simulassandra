...
\paragraph{Définition} Une \textit{donnée} est un codage (une représentation sous forme binaire), propre au système de base de données, d'une information quelconque.
%Assez précis ?%
...
\paragraph{}Ainsi que l'algorithme de gestion de copie, permettant d'établir le nombre de réplicats d'un objet en fonction de sa popularité.
...
\paragraph{Communication de la popularité} \besoin{1}{1} Un noeud stockant des copies doit communiquer la popularité de ces derniers au noeud possédant l'objet original.
