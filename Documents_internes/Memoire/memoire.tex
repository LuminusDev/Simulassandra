...
\paragraph{}Les résultats de ces expériences ne sont qu'un début. L'implémentation n'étant pas totale, il est encore trop tôt pour en tirer des conclusions quant à la performance des algorithmes utilisés. On peut cependant remarquer que les performances n'en sont pas pour autant diminuées. Tout porte donc à croire qu'avec une implémentation complète, les gains seraient visiblement immédiatement.
