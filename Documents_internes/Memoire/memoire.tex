...
La base de données n'étant pas relationnelle, dénombrer les lignes peut prendre énormément de temps au point que Cassandra renvoie une erreur de type \texttt{Time out}.
...
Pour cela, lors de la création d'un objet \class{KeySpace}, la première requête que nous effctuons est compter le nombre de ligne de chaque table.
...
la possibilité de rendre optionnel le decompte du nombre de lignes.
