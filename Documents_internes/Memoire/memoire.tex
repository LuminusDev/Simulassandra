...
\begin{itemize}
 ...
 \item \texttt{<s>} La seed pour l'initialisation du générateur de nombres aléatoires. Cela permet de répéter le même jeu de requêtes.
...
On peut ainsi demander à l'utilisateur quelle valeur il souhaite pour l'attribut \texttt{column\_target} avec le code suivant :
