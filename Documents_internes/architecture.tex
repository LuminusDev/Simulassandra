...
\paragraph{} Nous allons devoir sortir des données. Pour ça, Metrics ! Parler de JMX, de la librairie Metrics, et des possibilités pour notre projet grâce à ça (je pense aux histogrammes). Tout est surveillés dans Cassandra, facile d'avoir des infos sur un peu tout du coup.
